...
def no_action():
    cp_misty.move_head(0, 10, "null")
    time.sleep(.5)
    cp_misty.move_head(0, -20, "null")
    time.sleep(.5)
    cp_misty.move_head(0, 10, "null")
    time.sleep(.5)
    cp_misty.move_head(0, -20, "null")
...
def main():
    ...
    actions = [
            ...
            [sg.Button("LOVE", key = 'LOVE'), sg.Button("HELLO", key='HELLO'), sg.Button("NOD", key = 'NOD'), sg.Button('NO', key='NO')],
            [sg.Button("LAUGH", key = 'LAUGH'), sg.Button("AMAZING", key='AMAZING'), sg.Button("SAD", key="SAD")],
            [sg.Button("MAD", key='MAD'), sg.Button("SCARED", key='SCARED'), sg.Button("BYE", key="BYE")]
    ]
